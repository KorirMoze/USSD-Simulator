...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "082110e3-aea0-4668-a320-58f106285f9c",
  ...
  "public": {
    "googleClientId": "189394847723-fj000ar072gfbm1qtra975ae0kd8r6bu.apps.googleusercontent.com"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_QCcgIo = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_QCcgIo, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QCcgIo, lazy: true, middleware: false, method: undefined }
];
