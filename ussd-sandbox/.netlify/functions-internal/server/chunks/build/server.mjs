...
import { m as hasProtocol, o as isScriptProtocol, p as joinURL, w as withQuery, s as sanitizeStatusCode, q as getContext, $ as $fetch, r as createHooks, t as executeAsync, k as createError$1, v as toRouteMatcher, x as createRouter$1, y as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DtamdYLk.mjs')
  },
  {
    name: "sandbox",
    path: "/sandbox",
    component: () => import('./sandbox-Bw7lTyoV.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Cwry2aKu.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BbSY6Qq_.mjs'));
